...
public class OVRGrabber : MonoBehaviour
{
    ...
    protected void CheckForGrabOrRelease(float prevFlex)
    {
        ...
        else if (m_grabbedObj != null && m_grabbedObj.SnapToOriginAfterRelease && !m_grabbedObj.forced)
        {
            m_grabbedObj.forced = true;
            GrabEnd();
    ...
    protected bool requestGrabRelease = false;
    protected void GrabbableRelease(Vector3 linearVelocity, Vector3 angularVelocity)
    {
        if (m_grabbedObj.SnapToOrigin)
            requestGrabRelease = true;
        else
        {
            if (m_grabbedObj.SnapToOriginAfterRelease)
                m_grabbedObj.SnapToOrigin = true;

            m_grabbedObjReset(linearVelocity, angularVelocity);
        }
    }

    protected void m_grabbedObjReset(Vector3 linearVelocity, Vector3 angularVelocity)
    {
